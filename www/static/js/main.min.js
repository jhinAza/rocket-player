...
function k(a){console.log("Unfollowed!!");$("#follow").removeClass("btn-warning").addClass("btn-info").html("Seguir!").data("following","false");console.log(a)}function d(a){console.log(a)}function l(){console.log("Hola!!")}function c(a){options={url:"/requests.php",success:d,data:{type:"update-vote",vote:a,video:url("?video")}};$.post(options)}function g(a,b){options={url:"/requests.php",success:d,data:{type:"update-comment-vote",vote:a,comment:b}};$.post(options)}$("#loginUser").submit(function(a){a=
...
function(a){if(1==$(this).data("following")){a="unfollow";var b=k}else a="follow",b=h;$.post({url:"/requests.php",success:b,data:{type:a,followed:url("?uid")||$(this).data("uid")}})});$("#vote-up").on("click",function(a){$(this).data("voted")?c(0):c(1);$(this).toggleClass("active").data("voted",!$(this).data("voted"));$("#vote-down").removeClass("active").data("voted",!1)});$("#vote-down").on("click",function(a){$(this).data("voted")?c(0):c(-1);$(this).toggleClass("active").data("voted",!$(this).data("voted"));
$("#vote-up").removeClass("active").data("voted",!1)});$(".vote-comment").on("click",function(a){a=$(this).parent().data("comment-id");if($(this).data("voted"))g(0,a);else{var b=$(this).data("vote");g(b,a)}$(this).siblings(".vote-comment").removeClass("active").data("voted",!1);$(this).toggleClass("active").data("voted",!$(this).data("voted"))});$("#send-search").click(function(a){a=$("#search").val();console.log(a);3<a.length?window.location="/search.php?query="+a:bsAlert("El contenido del campo de busqueda debe ser mayor de 3 caracteres",
"warning")});$(".user-img").click(function(a){$("#img-file").trigger("click")});$("#img-file").on("change",function(a){a={data:{type:"updateUserImage"},url:"/requests.php",type:"post",resetForm:!1,success:d,beforeSubmit:l};$("#img-form").ajaxSubmit(a)})});function bsAlert(e,f){$("#alert-pos").append(alert)};
