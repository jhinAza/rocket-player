...
function GenericMediaController(a){this.id=a;this.media=document.getElementById(a);this.$media=$(this.media);this.$media.is("video")?this.type="video":this.$media.is("audio")&&(this.type="audio");this.engine="unknown";this.controls={};this.controls.override={};this.components={};this.components.intern={};this.currentSubIndex=-1;this.setEvents();debug&&console.log(this)}GenericMediaController.prototype.constructor=GenericMediaController;
GenericMediaController.prototype.stop=function(){this.pause();this.setTime(0)};GenericMediaController.prototype.play=function(){this.isPlaying()||(this.media.play(),this.components.sign&&this.components.sign.play())};GenericMediaController.prototype.mute=function(){this.isMuted()?(volume=document.querySelector(this.controls.volume).value,this.setVolume(parseFloat(volume))):this.setVolume(0)};
GenericMediaController.prototype.pause=function(){this.isPlaying()&&(this.media.pause(),this.components.sign&&this.components.sign.pause())};GenericMediaController.prototype.toString=function(){return this.media.toString()+this.engine};GenericMediaController.prototype.isMuted=function(){return 0==this.media.volume};GenericMediaController.prototype.isPlaying=function(){return!this.media.paused};GenericMediaController.prototype.isFullscreen=function(){return this.container===document.fullscreenElement};
GenericMediaController.prototype.hasAutoPlay=function(){return void 0!=this.$media.attr("autoplay")};GenericMediaController.prototype.getSize=function(){return[this.getHeight(),this.getWidth()]};
...
this.controls.override.mute=d;d||($(this.controls.mute).children().hide(),$(this.controls.mute).children(".high-volume").show());break;case "volume":$(a).on("change",function(a){c.setVolume(this.value)});volume=document.querySelector(a).value;this.setVolume(parseFloat(volume));this.controls.volume=a;break;case "subs":$(a).click(function(){c.toggleSubs()}),this.controls.subs=a}}};
GenericMediaController.prototype.addComponent=function(a,b,d){d=void 0===d?!1:d;if($(a)){var c=this;switch(b){case "subs":this.components.subs=a;this.components.intern.subs=$(d);break;case "trans":this.components.trans=a;this.components.intern.trans=$(d);$(d).click(function(){var a=$(this).data("init");c.setTime(a)});break;case "sign":this.components.sign=document.querySelector(a),this.components.intern.sign=$(d),$(a)[0].volume=0}}};
GenericMediaController.prototype.updateSubs=function(){var a=this,b=this.getCurrentTime();$.each($(this.components.intern.subs),function(d,c){if(d<this.currentSubIndex)return!0;var f=parseFloat($(this).data("init")),e=parseFloat($(this).data("end"));if(f<=b&&e>=b)return $(a.components.intern.subs).hide(),$(this).show(),a.currentSubIndex=d,!1})};
GenericMediaController.prototype.updateTrans=function(){var a=this,b=this.getCurrentTime();$.each($(this.components.intern.trans),function(d,c){if(d<this.currentSubIndex)return!0;var f=parseFloat($(this).data("init")),e=parseFloat($(this).data("end"));if(f<=b&&e>=b&&d!=a.currentSubIndex)return $(a.components.intern.trans).removeClass("active"),$(this).addClass("active"),f=$(this).position().top,e=.25*$(a.components.trans).height(),$(a.components.trans)[0].scrollTop+=f,$(a.components.trans)[0].scrollTop-=
e,!1})};GenericMediaController.prototype.toggleSubs=function(){$(this.components.subs).is(":visible")?$(this.components.subs).hide():$(this.components.subs).show()};function WebkitMediaController(a){GenericMediaController.call(this,a);this.engine="webkit"}WebkitMediaController.prototype=Object.create(GenericMediaController.prototype);WebkitMediaController.prototype.setFullScreen=function(){this.container.webkitRequestFullScreen();this.$container.addClass("fullscreen")};
WebkitMediaController.prototype.exitFullScreen=function(){document.webkitExitFullscreen();this.$container.removeClass("fullscreen")};WebkitMediaController.prototype.isFullscreen=function(){return this.container===document.webkitFullscreenElement};function GeckoMediaController(a){GenericMediaController.call(this,a);this.engine="Gecko"}GeckoMediaController.prototype=Object.create(GenericMediaController.prototype);
GeckoMediaController.prototype.setFullScreen=function(){this.container.mozRequestFullScreen();this.$container.addClass("fullscreen")};GeckoMediaController.prototype.exitFullScreen=function(){document.mozCancelFullScreen();this.$container.removeClass("fullscreen")};GeckoMediaController.prototype.isFullscreen=function(){return this.container===document.mozFullScreenElement};function IEMediaController(a){GenericMediaController.call(this,a);this.engine="MS"}IEMediaController.prototype=Object.create(GenericMediaController.prototype);
IEMediaController.prototype.setFullScreen=function(){this.container.msRequestFullscreen();this.$container.addClass("fullscreen")};IEMediaController.prototype.exitFullScreen=function(){document.msExitFullscreen();this.$container.css("background-color","black")};IEMediaController.prototype.isFullscreen=function(){return this.container===document.msFullscreenElement};window.Factory=new FactoryMediaController;
