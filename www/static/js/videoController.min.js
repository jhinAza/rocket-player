...
GenericMediaController.prototype.addComponent=function(a,b,d){if($(a)){var c=this;switch(b){case "subs":this.components.subs=a;this.components.intern.subs=$(d);break;case "trans":this.components.trans=a,this.components.intern.trans=$(d),$(d).click(function(){var a=$(this).data("init");c.setTime(a)})}}};
